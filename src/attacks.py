...
class G_BASE:
    ...
    def __init__(self, target_model, graph, loss_fn, config, shadow_models=None):
        ...
        print(f'Initialized G-BASE with threshold scale factor: {self.threshold_scale_factor}')
...
class BASE:
    ...
    def __init__(self, target_model, graph, loss_fn, config, shadow_models=None, offline_threshold_scale_factor=1.0):
        self.target_model = target_model
        self.graph = graph
        self.loss_fn = loss_fn
        self.config = config
        ...
        print(f'Initialized BASE with threshold scale factor: {self.threshold_scale_factor}')
